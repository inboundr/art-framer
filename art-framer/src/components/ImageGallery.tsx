...
export function ImageGallery() {
  ...
  return (
    <div className="flex flex-col items-center self-stretch bg-dark min-h-screen">
      <div className="flex px-1 py-6 flex-col items-center w-full max-w-7xl mx-auto">
          ...
          >
            {isLoading ? (
              <div className="flex items-center justify-center gap-2">
                <div className="w-4 h-4 border-2 border-gray-border border-t-gray-light rounded-full animate-spin"></div>
                <span className="text-gray-text">Loading more images...</span>
              </div>
            ) : (
