...
function NavItem({ icon, label, active = false, badge, onClick, isMobile = false }: NavItemProps) {
  ...
  return (
    <div className="flex pt-1 flex-col items-start">
      ...
      >
        <div className={`flex p-2 justify-center items-center rounded-lg ${active ? '' : ''}`}>
          <div className={`flex flex-col items-start ${active ? 'text-white' : 'text-gray-700'}`}>
            {icon}
          </div>
        </div>
        <div className="flex flex-col items-start">
          <div className="flex flex-col items-center">
            <span className={`text-center text-[11px] font-semibold leading-5 tracking-[-0.55px] ${active ? 'text-white' : 'text-gray-600'}`}>
              {label}
            </span>
          </div>
        </div>
        ...
        <div className="flex flex-col h-full bg-white border-r border-gray-300">
          ...
          <div className="flex items-center justify-between p-4 border-b border-gray-300">
            <div className="flex items-center gap-3">
              ...
              <h2 className="text-lg font-semibold text-gray-900">Art Framer</h2>
            </div>
            <button
              onClick={onClose}
            ...
            {user ? (
              <div className="space-y-3">
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex flex-col">
                    <span className="text-sm font-medium text-gray-900">{profile?.username || user.email}</span>
                    <span className="text-xs text-gray-muted">{profile?.is_premium ? 'Premium' : 'Free Plan'}</span>
                  </div>
                </div>
                <button
                  onClick={handleLogout}
                  className="w-full px-3 py-2 text-sm text-gray-900 hover:text-gray-900 hover:bg-gray-border/20 rounded-lg transition-colors"
                >
                  Sign Out
                </button>
              </div>
              ...
              <div className="text-center space-y-3">
                ...
                <button
                  ...
                  className="w-full px-3 py-2 text-sm text-gray-900 hover:text-gray-900 hover:bg-gray-border/20 rounded-lg transition-colors border border-gray-300"
                >
                  Sign In
                </button>
              </div>
  ...
  return (
    <div className="fixed left-0 top-0 h-full w-20 z-40">
      <div className="flex w-[80.5px] flex-col items-start h-full">
        <div className="flex p-1 px-2 pb-2 flex-col items-start self-stretch border-r-[0.5px] border-gray-300 bg-white h-full">
          {/* Logo */}
          ...
          <div className="flex pb-2 flex-col justify-center items-center self-stretch">
            ...
            <div className="flex pt-2 flex-col items-start">
              {user ? (
                <button className="flex min-w-16 px-2 py-1.5 flex-col justify-center items-center gap-1 rounded-lg bg-pink-accent hover:bg-pink-accent/90 transition-colors">
                ...
                <button 
                  ...
                  className="flex min-w-16 px-2 py-1.5 flex-col justify-center items-center gap-1 rounded-lg bg-gray-600 hover:bg-gray-500 transition-colors"
                >
                  <div className="flex pr-2.5 justify-center items-center gap-0.5">
